...
Partial Class Default2
    ...
    Private Const QUESTION_TWO As String = "You look like a Fred to me, are you really sure your name is "
    ...
    Protected Sub MultiTabButtons_Click(sender As Object, e As EventArgs) Handles Tab1Button.Click, Tab2Button.Click, Tab3Button.Click
        ...
        Select Case (buttonChosen.ID)
            ...
            Case Tab3Button.ID
                buttonChosen.BackColor = Tab3Panel.BackColor
        ...
        buttonChosen.ForeColor = Color.Yellow
    ...
    Private Sub ResetTabItems()
        ...
        Tab1Button.BackColor = Color.WhiteSmoke
        Tab2Button.BackColor = Color.WhiteSmoke
        Tab3Button.BackColor = Color.WhiteSmoke
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Tab1Panel.BackColor = Color.SeaGreen
        Tab2Panel.BackColor = Color.SteelBlue
        Tab3Panel.BackColor = Color.RosyBrown
    ...
    Protected Sub ButtonInTab2_Click(sender As Object, e As EventArgs) Handles ButtonInTab2.Click
        Label2.Text += " " & TextBoxInTab2.Text & ", hmm did not that author say, 'Tab B, or not Tab B, that is the question... wait it is Tab 2 not Tab B"
    End Sub
    Protected Sub Tab3YesButton_Click(sender As Object, e As EventArgs) Handles Tab3YesButton.Click

        Label3.Text += " Ok, Ok, I beleive you."
        LabelInsideTab3.Text = ""
